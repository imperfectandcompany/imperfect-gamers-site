...
const ModalHeader: React.FC<ModalHeaderProps> = ({
	...
	const backButton = (
		<button
			className="form-title animate flex animate-pulse cursor-pointer items-center !text-stone-500 transition-all hover:opacity-85 focus:text-white focus:opacity-50"
