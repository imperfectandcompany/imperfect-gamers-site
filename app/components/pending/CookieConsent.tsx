...
import type { FunctionComponent, MouseEvent, KeyboardEvent, ReactNode, FC } from 'react'
...
const CookieConsent: FunctionComponent = () => {
	...
	interface AccordionItemProps {
	  ...
	  const AccordionItem: FC<AccordionItemProps> = ({ title, children, isOpen, onClick }) => {
	  ...
	  const cookieSections = [
		{
			...
			content: (
				<>
					<p>The functionalities for which we use these technologies may include, but are not limited to, the following:</p>
					<ul>
						<li>Understanding how you navigate through our website</li>
						<li>Personalizing your experience on our site</li>
						<li>Providing you with customized content or offers on our site or within our advertising</li>
		...
		},
		{
			...
			content: (
				<>
					<p>In the context of this policy, 'we', 'our', and 'us' refers to store.imperfectgamers.org and 'you' refers to you, as the user of this website.</p>
					<p>By using store.imperfectgamers.org, you accept our use of cookies in accordance with this Cookie Policy. If you do not accept the use of cookies, please disable them as instructed in this Cookie Policy, so they are not downloaded to your device when you use our website.</p>
					<p>We reserve the right to modify this Cookie Policy at any time. Any changes will be effective immediately upon posting to the website, so please review it frequently.</p>
				</>
			)
		},
		{
			title: "How We Use Cookies",
			content: <p>At Imperfect Gamers, we use cookies for various purposes to enhance your browsing experience and provide personalized services.</p>
		},
		{
			title: "Types of Cookies We Use",
			content: (
				<ol>
					<li><strong>Analytics Cookies:</strong> These cookies allow us to gather information about how our website is used, including the number of visitors, the pages visited, and the time spent on each page.</li>
					<li><strong>Login Cookies:</strong> Login cookies are used to remember your preferences and enable you to log in to our website more efficiently.</li>
					<li><strong>Preference Cookies:</strong> Preference cookies are used to remember your preferences and settings on our website.</li>
				</ol>
			)
		},
		{
			title: "Third-Party Cookies",
			content: <p>In addition to our own cookies, we also employ certain third-party cookies to enhance our website's functionality and provide a better user experience.</p>
		},
	];
			...
			content: (
				<>
					...
					<ul>
						...
						<li><p><strong>Website</strong> refers to Store - Imperfect Gamers, accessible from <a href="https://store.imperfectgamers.org" target="_blank">https://store.imperfectgamers.org</a></p></li>
		...
		},
		{
			...
			content: (
				<>
					...
					<p>Personal Data, Usage Data, Information from Third-Party Social Media Services.</p>
					<h4>Tracking Technologies and Cookies</h4>
					<p>We use Cookies and similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and analyze Our Service.</p>
					<ul>
						<li><strong>Cookies or Browser Cookies.</strong> A cookie is a small file placed on Your Device. Unless you have adjusted Your browser setting so that it will refuse Cookies, our Service may use Cookies.</li>
					...
					<p>The Company may use Personal Data for various purposes including to provide and maintain our Service, manage Your Account, for the performance of a contract, to contact You, to provide You with offers, manage Your requests, and for business transfers.</p>
				</>
			)
		},
		{
		...
		},
		{
			...
			content: (
				<>
					...
					<p>Business Transactions, Law enforcement, Other legal requirements such as complying with a legal obligation, protecting and defending the rights or property of the Company, etc.</p>
					<h3>Security of Your Personal Data</h3>
					<p>The security of Your Personal Data is important to Us, but no method of transmission over the Internet, or method of electronic storage is 100% secure. We strive to use commercially acceptable means to protect Your Personal Data.</p>
				</>
			)
		},
		{
			title: "Children's Privacy, Links to Other Websites, and Changes to this Privacy Policy",
			content: (
				<>
    ...
    <p>
      {activeModal === 'cookie' ? (
		<div className="max-h-72 overflow-y-scroll">
                        <p className="intro-text">This Cookie Policy is designed to inform you about our practices regarding the collection of information through cookies and other tracking technologies. We aim to be transparent about how we use these technologies and how they affect your privacy.</p>
		...
		<div className="max-h-72 overflow-y-scroll">
                        <p className="intro-text">This Privacy Policy is crafted to inform you about how we manage, protect, and utilize your personal information across our services. As you enjoy our services, it’s important for you to understand how and why we collect your data, and how your information is handled with respect, in line with prevailing privacy laws.</p>
