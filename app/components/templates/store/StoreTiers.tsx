...
const premiumFeatures = [
    ...
    { 
        ...
        included: false, 
        tooltip: 'To access a custom IG server, please reach out to us directly. This exclusive service is available to our VIP clients only and cannot be obtained through the standard store. Ensure you are logged in as a VIP for more details.' 
    },
];
...
const StoreTiers: React.FC = () => (
    <div className="relative">
        ...
        <div className="mb-6 flex flex-col gap-2 lg:mb-12">
            {/* Heading */}
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl"> Available <span className="text-red-400">Membership</span> Tiers </h2>
            {/* Description */}
            <p className="block font-display text-white/60">Premium is currently in <span className="text-white/65">BETA</span></p>
        </div>
