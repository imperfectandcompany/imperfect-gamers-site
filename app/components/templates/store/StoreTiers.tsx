...
const premiumFeatures = [
	...
	{ name: 'Access to Premium Servers', included: true },
	{
		...
		included: true,
		tooltip: 'Reserve slot for when the server is full.',
	},
	{ name: 'Vote Extend', included: true },
	{
		name: 'In-Game Premium Tag',
		included: true,
		tooltip: '[PREMIUM] Tags in chat/scoreboard with custom text/name color.',
	},
	{
		name: 'In-Game Chat Color',
		included: true,
		tooltip: '[PREMIUM] Tags in chat/scoreboard with custom text/name color.',
	},
	{
		...
		included: true,
		tooltip:
			'275x55 gif of your choosing for your hud it will be visible for spectators and if you set a bot.',
	},
	// ... other features
	{
		...
		"
			>
				...
				<MembershipTier
					...
					trialInfo={
						isAuthenticated && username && isSteamLinked && isPremium
							? 'Your Current Membership'
							: "20% off. It's our launch, not a sale!"
					}
					trialPrimary={false}
					additionalInfo="Enjoy an elegant experience with Premium membership. Full access to all servers and additional perks. Additional terms and conditions apply."
				/>
			</div>
		</div>
	)
