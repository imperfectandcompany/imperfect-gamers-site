          ...
          What Our Members Say
            ...
            experience so much better!"
					...
					<Testimonial
						...
						imageSrc="https://placehold.co/100x100"
					>
            "The premium membership perks are incredible. I love the custom HUD
            and the priority support. It's worth every penny!"
					</Testimonial>
					{/* Testimonial 3 */}
					<Testimonial
						name="Granny Apple"
						...
						imageSrc="https://placehold.co/100x100"
					>
            "I've been a member for over a year now, and the community has been
            incredibly welcoming. The slot reservation feature is a lifesaver
            during peak hours."
					</Testimonial>
				</div>
			</div>
