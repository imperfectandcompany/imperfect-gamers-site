...
const reviews: Review[] = [
	{
	  ...
	  imageSrc: 'https://cdn.imperfectgamers.org/inc/assets/img/profile_pictures/discord/feedback/phazejeff.png',
	  content: 'can vips be allowed to join the server when its full',
	},
	{
	  name: 'Kirk',
	  date: '05/29/2024 9:03 PM',
	  imageSrc: 'https://cdn.imperfectgamers.org/inc/assets/img/profile_pictures/discord/feedback/kirk.png',
	  content: 'when is the VIP dropping? I need the custom models',
	},
	{
	  name: 'Quintin',
	  date: '05/29/2024 6:19 PM',
	  imageSrc: 'https://cdn.imperfectgamers.org/inc/assets/img/profile_pictures/discord/feedback/default_discord_picture.png', // No specific image provided
	  content: 'can you even buy vip rn',
	},
	{
	  name: 'Krayy',
	  date: '05/26/2024 11:14 PM',
	  imageSrc: 'https://cdn.imperfectgamers.org/inc/assets/img/profile_pictures/discord/feedback/Krayy.png',
	...
	},
	{
	  ...
	  imageSrc: 'https://cdn.imperfectgamers.org/inc/assets/img/profile_pictures/discord/feedback/Pinball.jpeg',
	  content: 'T1-2 was full',
	},
	{
	  name: 'Wildcard',
	  date: '06/12/2024 8:10 PM',
	  imageSrc: 'https://cdn.imperfectgamers.org/inc/assets/img/profile_pictures/discord/feedback/Wildcard.jpeg',
	  content: 'i can\'t get into easy surf cuz its full',
	},
	{
	  name: 'DubzXI',
	  date: '05/28/2024 12:50 AM',
	  imageSrc: 'https://cdn.imperfectgamers.org/inc/assets/img/profile_pictures/discord/feedback/DubzXI.gif',
	...
	},
	{
	  ...
	  imageSrc: 'https://cdn.imperfectgamers.org/inc/assets/img/profile_pictures/discord/feedback/kiro.png',
    ...
    return (
		<section className="py-12">
		  <div className="container mx-auto px-4">
			<h2 className="mb-8 text-center text-3xl font-bold">You shared. We listened.</h2>
			...
			<div className="flex justify-center mt-8">
			  {visibleCount < reviews.length && (
				<button
				  className="bg-gradient-to-r from-red-600 to-red-900 text-white px-4 py-2 rounded hover:bg-red-700 transition duration-200 button"
			  ...
			  {visibleCount > 3 && (
				<button
				  className="bg-gradient-to-r from-gray-500 to-gray-700 text-white px-4 py-2 rounded hover:bg-gray-700 transition duration-200 ml-4 button"
