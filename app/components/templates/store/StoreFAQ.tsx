...
const faqs = [
	{
		...
		answer: (
			<p>
        You may view above to take a look at the rewards offered for being a
        premium member on Imperfect Gamers, but if you'd like to speak to
        someone, you can do so on our{' '}
				<a
					href="https://imperfectgamers.org/discord"
					target="_blank"
					rel="noopener noreferrer"
				>
					<span className="text-red-400 hover:underline font-medium">
            Discord
					</span>
				</a>
        .
