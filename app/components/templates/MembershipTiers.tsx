...
const MembershipTiers: React.FC = () => (
    <div className="relative">
      ...
      <div className="mb-6 flex flex-col gap-2 lg:mb-12">
         <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl"> Available <span class="text-red-400">Membership</span> Tiers </h2>
         <p className="block font-display text-white/60">Premium is currently in <span class="text-white/65">BETA</span></p>
      </div>
